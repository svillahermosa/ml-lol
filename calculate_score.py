...
df_2 = pd.read_csv(r'C:\DevelopmentLaLiga\ml-lol\extracts\full_low_elo.tsv', sep='\t')
...
df3 = df_full[['jugador', 'pk_partida', 'lane']]
...
df_merged_2.to_csv(r'C:\DevelopmentLaLiga\ml-lol\extracts\full.tsv', sep='\t')
